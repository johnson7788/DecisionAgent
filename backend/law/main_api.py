...
def main(host, port):
    ...
    agent_card_name = "Law Consultant Agent"
    agent_name = "law_consultant"
    # Agent描述必须清晰
    agent_description = "Based on the user's legal situation, provide relevant legal information and detailed introductions."
