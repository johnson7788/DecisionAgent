...
def main(host, port):
    ...
    agent_card_name = "Customer Service Agent"
    agent_name = "customer_service"
    # Agent描述必须清晰
    agent_description = "Answer user questions based on the knowledge base and provide solutions."
